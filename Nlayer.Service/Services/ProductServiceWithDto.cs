...
namespace Nlayer.Service.Services
{
    public class ProductServiceWithDto : ServiceWithDto<Product, ProductDto>, IProductServiceWithDto
    {
        ...
        public ProductServiceWithDto(IProductRepository productRepository, IMapper mapper, IUnitOfWork unitOfWork, IGenericRepository<Product> repository) : base(mapper, unitOfWork, repository)
        {
